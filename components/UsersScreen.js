...
class UsersScreen extends React.Component {
        ...
        if (status !== 'granted') {
            ...
            .then(
              json => {
                  ...
                  fetch('http://10.2.105.66:3000/location', {
                      method: 'POST',
                      headers: {
    ...
    componentDidMount() {
        let self = this;
        fetch(`http://10.2.105.66:3000/users?currentUser=${myShit.currentUser}`).then((response) => response.json()).then(function(responseJson) {
